...
# task 2
# Actually, I'm not sure about this task, because nosetests shows 95% coverage
# for this file, but 1% TOTAL. Seems that nosetests wants me to cover with
# tests matplotlib module.
...
def go_on(bct_name='Pseudomonas aerugenosa', f1=0.4, f2=5,
          medium_name='MacConkey Agar', lymit1=1000000,
          lymit2=1000000, f3=0.85, sci_name='Maxim Belov'):
    bact = Bacteria(bct_name, f1, f2)
    bact.description()
    med = Medium(medium_name, lymit1, lymit2, f3)
    sci = Scientist(sci_name)
...
class MyTest(unittest.TestCase):
    def test(self):
        self.assertEqual(go_on('Aspergilla', 0.3, 4, 'Chocolate agar',
                               500, 500, 0.5, 'Nikita Belov'))
