...
# if the index provided exceeds the length of the list.
...
# which handles a possible KeyError
# if the list with the name provided doesn’t exist
# in the dictionary yet, instead of checking beforehand whether it does.
...
a = {"1": [1]}
add_to_list_in_dict(a, "1", 2)
add_to_list_in_dict(a, "2", 3)
print(a)
